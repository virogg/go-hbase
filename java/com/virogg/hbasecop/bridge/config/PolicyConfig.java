...
public final class PolicyConfig {
  ...
  private static final Map<Byte, String> HOOK_ID_TO_NAME =
      Map.of(
          RegionObserverAdapter.HOOK_PRE_PUT, "prePut",
          RegionObserverAdapter.HOOK_POST_PUT, "postPut");
  ...
  public HookPolicy forHook(byte hookId) {
    String name = HOOK_ID_TO_NAME.get(hookId);
    if (name == null) {
