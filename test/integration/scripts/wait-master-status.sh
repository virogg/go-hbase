...
#
# Gate the integration suite on the HBase standalone cluster being truly ready, in two phases:
...
# RPC readiness - the cluster can actually serve a meta operation.
