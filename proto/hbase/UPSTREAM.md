...
[apache/hbase][hbase], rewritten under our own package alias so generated
code links into this project without pulling in HBase's runtime jars.
...
- `package hbase.pb;` becomes `package virogg.hbasecop.hbase.v1;`
- `option java_package = "org.apache.hadoop.hbase.shaded.protobuf.generated";`
  becomes `option java_package = "com.virogg.hbasecop.hbase.v1";`
...
- `import "X.proto";` becomes `import "hbase/X.proto";` so a single
...
wire encoding stays compatible with HBase itself; this lets a RegionObserver
hand a `Put` straight to the Go side without translation.
